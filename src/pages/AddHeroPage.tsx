...
const AddHeroPage = () => {
    ...
    const createHero = () => {
        HeroService.createHero(newHero, chosenFiles, chosenPowers).then(res => {
        ...
        <div className={"flex items-center justify-center flex-col pt-10"}>
            <div className={"grid grid-cols-2 w-1/2 border-2 rounded-lg p-5 gap-5"}>
                <div>
                    ...
                    <input onChange={e => {
                        setNewHero({...newHero, nickname: e.target.value})
                ...
                <div>
                    ...
                    <input onChange={e => {
                        setNewHero({...newHero, real_name: e.target.value})
                    }} className={"border-2 rounded p-1"} type="text"/>
                </div>
                ...
                <div className={'col-span'}>
                    ...
                    <textarea onChange={e => {
                        setNewHero({...newHero, origin_description: e.target.value})
                ...
                <div>
                    ...
                    <textarea onChange={e => {
                        setNewHero({...newHero, catch_phrase: e.target.value})
                    }} className={"border-2 rounded w-full h-full p-1"}/>
                </div>
                ...
                <div className={"flex justify-center col-span-2"}>
                    <button className={"border-2 rounded-lg px-5 py-2 bg-green-300"} onClick={createHero}>
                        Create
                    </button>
                </div>
            </div>
